...
- feat(projects): company-level chat (BILTIQ-004) — chat over ALL of a company's runs within a project; `CompanyChat` collection + `buildCompanyContext` aggregator + `/api/projects/:id/companies/:company/chat`; per-company Chat drawer on the project detail page (ADR-0006)
